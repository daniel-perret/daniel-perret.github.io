...
<h1 style="text-align: center; margin-top: 2rem; margin-bottom: 3rem;">About Me</h1>

<div class="row align-items-center mb-5">
  <div class="col-md-4 text-center mb-4 mb-md-0">
    <img src="../images/IMG_8642clip.jpg?raw=true" alt="Profile photo" style="max-width: 250px; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1);">
  </div>
  <div class="col-md-8">
    <div class="card">
      <div class="card-body">
